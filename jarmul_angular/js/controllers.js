function MainCtrl($rootScope,$window,$scope,Idle) {
    var url_now = $window.location.href.toString().split($window.location.host)[1];

    if(typeof localStorage.id != 'undefined' && url_now == "/jarmul_angular/#/login"){
        $window.location.href = "/jarmul_angular/#/dashboards/dashboard_1";
    }
    else if(typeof localStorage.id == 'undefined'){
        $window.location.href = "/jarmul_angular/#/login";
    }
    else{
    ...
    if($rootScope.session_id){
        ...
        $scope.$on('IdleStart', function () {
            $scope.timeout = setTimeout(function(){ $scope.logout();}, 55000);
        });
 ...
 */
function idleTimer($rootScope, $scope, Idle, notify) {
    ...
    $scope.$on('IdleStart', function () {
        ...
        setTimeout(function(){ $rootScope.logout();}, 2000);
