    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'TEKNIK INFORMATIKA | Institut Teknologi Sepuluh Nopember Surabaya';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'TEKNIK INFORMATIKA | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
